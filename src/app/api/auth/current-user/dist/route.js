...
var auth_1 = require("@/lib/auth"); // Folosește configurația ta existentă
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error getting current user from NextAuth:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({ success: false, error: 'Failed to get current user' }, { status: 500 })];
