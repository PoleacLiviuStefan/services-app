...
const MainCharacteristic = ({label,characteristic}:{label:string,characteristic:string}) => {
  return (
    <li className="flex flex-col items-center justify-center  rounded-lg w-[90px] lg:w-[150px] h-[80px] p-1 text-white  bg-primaryColor lg:space-y-1 font-extrabold  text-center">
