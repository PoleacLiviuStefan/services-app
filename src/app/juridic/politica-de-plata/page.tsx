...
const PoliticaDePlata = () => {
  return (
    ...
    w-full py-[10rem]'>
        ...
        <p>
            În vederea garantării securității tranzacțiilor, platforma utilizată de mysticgold.app este STRIPE.
        </p>
        <p>
        ...
        <p>
            Procesarea datelor de card se realizează exclusiv prin intermediul platformei de plată STRIPE. Compania MYSTICGOLD SRL nu solicită și nu stochează nicio informație referitoare la cardul dumneavoastră.
        </p>
        </div>
    </div>
  )
