...
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        var body, _a, userId, scheduledEventUri, dbPr, realProviderId_1, token_1, refreshToken_1, expiresAt_1, mainSpecialityId, res, _b, scheduledJson, rsrc, scheduledAtStr, startStr, endStr, member, email, name, scheduledAt, startDate, endDate, duration, client, specialityId, pkgs, userPkg, totalPrice, zoomRes, zoomJson, sessionName_1, tokens, created, fresh, err_1;
        var _this = this;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 11:
                    ...
                    member = Array.isArray(rsrc.event_memberships)
                        ? rsrc.event_memberships[0]
                        : null;
                    email = member === null || member === void 0 ? void 0 : member.user_email;
                    name = member === null || member === void 0 ? void 0 : member.user_name;
                ...
                case 12:
                    ...
                    return [4 /*yield*/, prisma_1.prisma.user.create({
                            data: { email: email, name: name || undefined, role: "STANDARD" },
                            select: { id: true }
                        })];
                case 13:
                    client = _c.sent();
                ...
                case 15:
                    ...
                    if (!userPkg) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: "Nu ai sesiuni disponibile." }, { status: 400 })];
                    }
                    ...
                    return [4 /*yield*/, fetch(process.env.NEXT_PUBLIC_BASE_URL + "/api/video/create-session", {
                            ...
                            body: JSON.stringify({
                                users: [realProviderId_1, client.id],
                                providerId: realProviderId_1,
                                clientId: client.id,
                ...
                case 17:
                    ...
                    sessionName_1 = zoomJson.sessionName, tokens = zoomJson.tokens;
                    return [4 /*yield*/, prisma_1.prisma.consultingSession.create({
                            ...
                            return __generator(this, function (_b) {
                                if (e instanceof client_1.Prisma.PrismaClientKnownRequestError &&
                                    e.code === "P2002" &&
                                    Array.isArray((_a = e.meta) === null || _a === void 0 ? void 0 : _a.target) &&
                                    e.meta.target.includes("zoomSessionName")) {
                                    // return existing if duplicate
                                    return [2 /*return*/, prisma_1.prisma.consultingSession.findUnique({
                                            where: { zoomSessionName: sessionName_1 }
                                        })];
                                }
                                throw e;
                            });
                ...
                case 19:
                    // 12. Increment usedSessions
                    _c.sent();
                    return [4 /*yield*/, prisma_1.prisma.consultingSession.findUnique({
                            where: { id: created.id }
                        })];
                case 20:
                    fresh = _c.sent();
                    return [2 /*return*/, server_1.NextResponse.json({ ok: true, data: fresh }, { status: 201 })];
                case 21:
                    err_1 = _c.sent();
                    console.error("Unexpected error în /api/calendly/event-scheduled:", err_1);
                    return [2 /*return*/, server_1.NextResponse.json({
                            error: "Eroare internă neașteptată",
                            details: err_1.message || String(err_1)
                        }, { status: 500 })];
