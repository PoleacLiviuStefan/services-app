...
function sendVerificationEmail(to, token) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = process.env.NEXT_PUBLIC_BASE_URL + "/verificare-mail?token=" + token;
...
function sendPasswordResetEmail(to, token) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = process.env.NEXT_PUBLIC_BASE_URL + "/resetare-parola?token=" + token;
                    return [4 /*yield*/, transporter.sendMail({
                            envelope: { from: process.env.FROM_MAIL, to: to },
                            from: "\"MysticGold\" <" + process.env.FROM_MAIL + ">",
                            to: to,
